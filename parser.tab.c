...
#include <stdio.h>
#include <stdlib.h>
#include "lex.yy.h"  // Include the Flex-generated header for yytext, yyin, etc.
...
static const char *const yytname[] =
{
  ...
  "REPEAT", "UNTIL", "WHILE", "FOR", "SWITCH", "CASE", "DEFAULT",
  "FUNCTION", "RETURN", "CONST", "AND", "OR", "NOT", "EQ", "NEQ", "GTE",
  "LTE", "GT", "LT", "PLUS", "MINUS", "MUL", "DIV", "EXP", "ASSIGN",
  "SEMI", "COLON", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "TYPE",
  "FLOAT", "INT", "BOOLEAN", "IDENTIFIER", "UNKNOWN", "UMINUS", "$accept",
  "program", "statement_list", "statement", "declaration", "assignment",
  "if_stmt", "while_stmt", "return_stmt", "expression", YY_NULLPTR
};
...
{
      -2,    25,    25,    25,   -29,   -16,    15,   -30,    -2,   -13,
     -10,   -30,   -30,    -4,    25,    25,    25,   -30,   -30,   -30,
     -30,    22,    -3,    35,   -30,    25,   -30,   -30,   -30,   -30,
     -30,   -30,   -30,   -18,    -2,    25,    25,    25,    25,   -30,
      35,   -30,    24,   -24,   -24,   -30,   -30,    -2,   -30
};
...
{
       4,     0,     0,     0,     0,     0,     0,     2,     4,     0,
       0,     7,     8,     0,     0,     0,     0,    17,    16,    18,
      15,     0,     4,    14,    10,     0,     1,     3,     5,     6,
       9,    25,    24,     0,     4,     0,     0,     0,     0,    13,
      11,    23,     0,    19,    20,    21,    22,     4,    12
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -30,   -30,    -6,   -30,   -30,   -30,   -30,   -30,   -30,    17
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     6,     7,     8,     9,    10,    11,    12,    13,    21
};
...
{
       1,     1,    27,    37,    38,     2,     2,    35,    36,    37,
      38,     3,     3,    24,    25,    26,    39,    41,    28,    22,
      23,    29,    35,    36,    37,    38,    34,    30,    42,    47,
       0,    31,    32,    33,     0,     4,     4,     0,     0,     5,
       5,    48,    40,    14,     0,     0,     0,    35,    36,    37,
      38,    15,    43,    44,    45,    46,     0,     0,     0,    16,
      35,    36,    37,    38,    17,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       3,     3,     8,    27,    28,     8,     8,    25,    26,    27,
      28,    14,    14,    42,    30,     0,    22,    35,    31,     2,
       3,    31,    25,    26,    27,    28,     4,    31,    34,     5,
      -1,    14,    15,    16,    -1,    38,    38,    -1,    -1,    42,
      42,    47,    25,    18,    -1,    -1,    -1,    25,    26,    27,
      28,    26,    35,    36,    37,    38,    -1,    -1,    -1,    34,
...
{
       0,     3,     8,    14,    38,    42,    46,    47,    48,    49,
      50,    51,    52,    53,    18,    26,    34,    39,    40,    41,
      42,    54,    54,    54,    42,    30,     0,    47,    31,    31,
      31,    54,    54,    54,     4,    25,    26,    27,    28,    47,
      54,    35,    47,    54,    54,    54,    54,     5,    47
};
...
#line 1154 "parser.tab.c"
  ...
  case 5: /* statement: declaration SEMI  */
#line 44 "parser.y"
                     { printf("Declaration statement parsed.\n"); }
#line 1160 "parser.tab.c"
    break;

  case 6: /* statement: assignment SEMI  */
#line 45 "parser.y"
...
#line 1178 "parser.tab.c"
  ...
  case 9: /* statement: return_stmt SEMI  */
#line 48 "parser.y"
...
#line 1196 "parser.tab.c"
  ...
  case 12: /* if_stmt: IF expression THEN statement_list ELSE statement_list  */
#line 60 "parser.y"
                                                          { printf("If statement parsed.\n"); }
#line 1202 "parser.tab.c"
    break;

  case 13: /* while_stmt: WHILE expression statement_list  */
#line 64 "parser.y"
                                    { printf("While statement parsed.\n"); }
